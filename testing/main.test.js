...
test("Caesar Cipher", () => expect(caesarCipher('xyz', 3)).toBe('abc'))
test("Caesar Cipher", () => expect(caesarCipher('HeLLo', 3)).toBe('KhOOr'))
test("Caesar Cipher", () => expect(caesarCipher('Hello, World!', 3)).toBe('Khoor, Zruog!'))
